...
@section('content')
                                                        ...
                                                        <a href="{{ route('admin.driver.show', ['id' => $driver->id]) }}"
                                                           class="media d-inline-flex align-items-center gap-10">
                                                            <img loading="lazy"
                                                                 ...
                                                                 style="--size: 20px">
                                                            <div class="media-body" data-bs-toggle="tooltip" data-bs-placement="right"
                                                   data-bs-title="{{ translate('Verified') }}">{{ $driver?->first_name }}
                                                                {{ $driver?->last_name }} <img width="14" src="{{ asset('public/assets/admin-module/img/svg/verified-check.svg') }}" alt=""></div>
                                                        </a>
                                                    </td>
    ...
    <div class="m-5">
        <td class="name">
            <a href="" class="media d-inline-flex align-items-center gap-10">
                <img loading="lazy" src="http://localhost/HexaRide-Admin/storage/app/public/driver/profile/2023-11-20-655b66dfcd82a.png"
                    class="rounded custom-box-size" alt="" style="--size: 20px">
                <div class="media-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="{{ translate('Unverified') }}">
                    Devid Jack                
                    <img width="14" src="{{ asset('public/assets/admin-module/img/svg/unverified-check.svg') }}" alt="">
                </div>
            </a>
        </td>
    </div>
