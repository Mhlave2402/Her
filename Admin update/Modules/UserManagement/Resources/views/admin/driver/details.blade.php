                                    ...
                                    <div class="media-body">
                                        <div class="d-flex flex-column align-items-start gap-1">
                                            <h6 class="mb-10">
                                                ...
                                                <img width="14" src="{{ asset('public/assets/admin-module/img/svg/verified-check.svg') }}" alt="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="{{ translate('Verified') }}">
                                            </h6>
