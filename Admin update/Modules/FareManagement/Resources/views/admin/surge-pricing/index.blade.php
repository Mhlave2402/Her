...
@section('content')
                ...
                <div class="card-body">
                    <div class="table-top d-flex flex-wrap gap-10 justify-content-between">
                        <form action="javascript:;" class="search-form search-form_style-two"
                            ...
                            <div class="input-group search-form__input_group">
                                ...
                                <input type="search" class="theme-input-style search-form__input"
                                       ...
                                       placeholder="{{ translate('search_here_by_id, name') }}">
                            </div>
                        ...
                        <div class="d-flex flex-wrap gap-3">
                            <a href="{{ route('admin.fare.surge-pricing.index') }}" class="btn btn-outline-primary px-3" data-bs-toggle="tooltip"
                                ...
                                <table class="table table-borderless align-middle table-hover text-nowrap text-dark">
                                    ...
                                    @foreach($surgePricing as $key => $data)
                                        <tr>
                                            <td>{{ ++$key }}</td>
                                            <td>
                                                <a href="" class="fw-semibold fs-14">{{ $data->name }}</a>
                                                <br>
                                            ...
                                            <td>
                                                <label class="switcher mx-auto">
                                                    <input class="switcher_input surge_price_status_change"
                                                           ...
                                                           data-icon=" {{ $data->is_active == 1 ? asset('public/assets/admin-module/img/svg/turn-off-surge-pricing.svg') : asset('public/assets/admin-module/img/svg/turn-on-surge-pricing.svg')}}"
                            ...
                            <div class="rounded bg-light mt-3">
                                <div class="px-3 py-5">
                                    <div class="d-flex flex-column gap-2 align-items-center">
                                        <img src="{{asset('public/assets/admin-module/img/svg/surge.svg')}}" class="svg"
                                             alt="">
    ...
    <span class="script-url"
          data-script-select-2="{{ asset('public/assets/admin-module/js/select-2-init.js') }}"
          data-script-date-range-picker="{{ asset('public/assets/admin-module/js/date-range-picker.js') }}"
          data-script-surge-price-schedule="{{ asset('public/assets/admin-module/js/surge-price-schedule.js') }}"
    ></span>
@endsection
...
@push('script')
    ...
    <script src="{{  asset('public/assets/admin-module/js/fare-management/surge-pricing/create-edit.js') }}"></script>
@endpush
