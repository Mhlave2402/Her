        ...
        <div class="container-fluid">
                ...
                <div
                    ...
                    <label class="switcher mx-auto">
                        <input class="switcher_input surge_price_status_change"
                               ...
                               data-icon=" {{ $surgePrice->is_active == 1 ? asset('public/assets/admin-module/img/svg/turn-off-surge-pricing.svg') : asset('public/assets/admin-module/img/svg/turn-on-surge-pricing.svg')}}"
                        ...
                        <div class="col-lg-7">
                            <div class="card card-body border-0 h-100 d-flex flex-column gap-3">
                                ...
                                <div class="bg-light rounded p-20 d-flex gap-3 flex-column align-items-center justify-content-center flex-grow-1">
                                    <img src="{{ asset('public/assets/admin-module/img/svg/note.svg') }}" class="svg" alt="">
            ...
            <div class="card border-0">
                <div class="card-header d-flex flex-wrap justify-content-between gap-2 border-0 shadow-sm">
                    ...
                    <div>
                        <select class="js-select" id="getZoneStatsForSurgePricing">
