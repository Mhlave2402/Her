...
import 'package:her_driver_app/features/splash/screens/app_version_warning_screen.dart';
import 'package:her_driver_app/features/trip/controllers/trip_controller.dart';
import 'package:her_driver_app/helper/firebase_helper.dart';
...
import 'package:her_driver_app/features/maintainance_mode/screens/maintainance_screen.dart';
                ...
                if(value.statusCode ==200){
                  Get.find<LocationController>().getCurrentLocation().then((value){
                    if(widget.notificationData != null){
                      NotificationHelper.notificationToRoute(widget.notificationData!, formSplash: true, userName: widget.userName);
                    }else{
