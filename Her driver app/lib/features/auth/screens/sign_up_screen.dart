...
import 'package:her_driver_app/features/auth/screens/additional_sign_up_screen_1.dart';
                ...
                child: SingleChildScrollView(child: Column(children: [
                  ...
                  Padding(
                    ...
                    child: Text('select_your_preferable_service'.tr,
                      style: textRegular.copyWith(color: Theme.of(context).primaryColor.withValues(alpha: 0.5),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: authController.isRideShare ? Theme.of(context).primaryColor.withValues(alpha: 0.05) : null,
                    ),
                    child: Center(
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: authController.isParcelShare ? Theme.of(context).primaryColor.withValues(alpha: 0.05) : null,
                    ),
                    child: Center(
                      child: CheckboxListTile(
                        contentPadding:  const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
