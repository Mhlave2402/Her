...
import 'package:her_driver_app/features/map/widgets/rider_details_widget.dart';
...
import 'package:her_driver_app/features/ride/screens/record_shortfall_screen.dart';
              ...
              return Container(height: 90,
                ...
                Row(
                  children: [
                    Expanded(
                      child: ButtonWidget(
                        buttonText: 'record_shortfall'.tr,
                        onPressed: () {
                          Get.to(() => RecordShortfallScreen(tripId: finalFareController.finalFare!.id!));
                        },
                      ),
                    ),
