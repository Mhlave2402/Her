...
class _ChartWidgetState extends State<ChartWidget> {
  ...
  Widget leftTitleWidgets(double value, TitleMeta meta) {
   ...
   return SideTitleWidget(axisSide: meta.axisSide, child: Text(value, style: textRobotoRegular.copyWith(fontSize: 10,fontWeight: FontWeight.normal,color: Color(0xff68737d))));
