...
import 'package:her_driver_app/features/home/widgets/last_trip_shimmer_widget.dart';
import 'package:her_driver_app/features/home/widgets/custom_arrow_icon_widget.dart';
import 'package:her_driver_app/features/home/widgets/custom_menu_driving_status_widget.dart';
...
import 'package:her_driver_app/common_widgets/no_data_widget.dart';
        ...
        child: Container(
          ...
          child: Column(children: [
            ...
            Padding(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.center,children: [
                ...
                Padding(
                  ...
                  child: Text(
                    rideController.orderStatusSelectedIndex == 0?
                    '${onGoingHr.toString()}:$onGoingMin': rideController.lastRideDetails![0].estimatedDistance!.toStringAsFixed(2),
                    style: textBold.copyWith(fontSize: Dimensions.fontSizeLarge),
                  ),
                ),

                Text(
                  rideController.orderStatusSelectedIndex == 0?'Hour'.tr:'km'.tr,
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text('${'payment'.tr}:', style: textRegular.copyWith(color: Theme.of(context).hintColor)),
                  const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                  Text(
                    rideController.lastRideDetails![0].paymentMethod == 'split_payment'
                        ? 'Split Payment'
                        : rideController.lastRideDetails![0].paymentMethod!,
                    style: textBold.copyWith(fontSize: Dimensions.fontSizeLarge),
                  ),
                ],
              ),
            ),
            if (rideController.lastRideDetails![0].paymentMethod == 'split_payment')
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault),
                child: Row(
                  children: [
                    Text('${'split_with'.tr}:', style: textRegular.copyWith(color: Theme.of(context).hintColor)),
                    const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                    GetBuilder<ProfileController>(
                      builder: (profileController) {
                        // This is a placeholder for fetching the user's email from the user ID.
                        // You would need to implement a way to fetch the user's details from your backend.
                        return Text(
                          'user@example.com',
                          style: textBold.copyWith(fontSize: Dimensions.fontSizeLarge),
                        );
            ...
            if (rideController.lastRideDetails![0].withMaleCompanion)
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault),
                child: Row(
                  children: [
                    Text('${'traveling_with'.tr}:', style: textRegular.copyWith(color: Theme.of(context).hintColor)),
                    const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                    Text(
                      'male_companion'.tr,
                      style: textBold.copyWith(fontSize: Dimensions.fontSizeLarge),
