...
import 'package:her_driver_app/common_widgets/paginated_list_view_widget.dart';
import 'package:her_driver_app/features/help_and_support/controllers/help_and_support_controller.dart';
import 'package:her_driver_app/features/help_and_support/widgets/admin_conversation_bubble_widget.dart';
...
import 'package:her_driver_app/helper/image_file_helper.dart';
      ...
      child: CustomPopScopeWidget(
        child: Scaffold(
          appBar: AppBar(
            ...
            elevation: 2,backgroundColor: Theme.of(context).cardColor,
          ),
