...
import 'package:her_driver_app/helper/country_code_picke.dart';
...
class ProfileEditScreenState extends State<ProfileEditScreen>  with TickerProviderStateMixin {
  ...
  bool isNanny = false;
  bool isKidsOnlyVerified = false;
  bool acceptsLowerTierRides = false;
  bool isBike = false;
  bool isChildFriendly = false;
  bool hasBabySeat = false;
  bool acceptsMaleCompanion = false;
  ...
  void initState() {
    ...
    acceptsLowerTierRides = widget.profileInfo?.acceptsLowerTierRides ?? false;
          ...
          return GetBuilder<AuthController>(builder: (authController) {
            return SingleChildScrollView(child: Padding(
              ...
              child: Column(
                ...
                TextFieldTitleWidget(title: 'other_services'.tr),

                Row(children: [
                  Expanded(
                    child: CheckboxListTile(
                      tileColor: isNanny ? Theme.of(context).primaryColor.withValues(alpha: 0.05) : null,
                      contentPadding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
                      title: Text('nanny'.tr,style: textBold.copyWith(
                          fontSize: 12,
                          color: Theme.of(context).textTheme.bodyMedium!.color
                      )),
                      value: isNanny,
                  ...
                  Expanded(
                    child: CheckboxListTile(
                      tileColor: isKidsOnlyVerified ? Theme.of(context).primaryColor.withValues(alpha: 0.05) : null,
                      contentPadding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
                      title: Text('kids_only_verified'.tr,style: textBold.copyWith(
                          fontSize: 12,
                          color: Theme.of(context).textTheme.bodyMedium!.color
                      )),
                      value: isKidsOnlyVerified,
                      onChanged: (value){
                        isKidsOnlyVerified = value!;
                        setState(() {});
                      },
                      activeColor: Theme.of(context).primaryColor,
                      checkColor: Colors.white,
                ...
                CheckboxListTile(
                  tileColor: acceptsLowerTierRides ? Theme.of(context).primaryColor.withValues(alpha: 0.05) : null,
                  contentPadding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
                  title: Text('accept_lower_tier_rides'.tr,style: textBold.copyWith(
                      fontSize: 12,
                      color: Theme.of(context).textTheme.bodyMedium!.color
                  )),
                  value: acceptsLowerTierRides,
                  onChanged: (value){
                    acceptsLowerTierRides = value!;
                    setState(() {});
                  },
                  activeColor: Theme.of(context).primaryColor,
                  checkColor: Colors.white,
                ...
                Row(children: [
                  Expanded(
                    child: CheckboxListTile(
                      tileColor: isBike ? Theme.of(context).primaryColor.withValues(alpha: 0.05) : null,
                      contentPadding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
                      title: Text('bike'.tr,style: textBold.copyWith(
                          fontSize: 12,
                          color: Theme.of(context).textTheme.bodyMedium!.color
                      )),
                      value: isBike,
                  ...
                  Expanded(
                    child: CheckboxListTile(
                      tileColor: isChildFriendly ? Theme.of(context).primaryColor.withValues(alpha: 0.05) : null,
                      contentPadding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
                      title: Text('child_friendly'.tr,style: textBold.copyWith(
                          fontSize: 12,
                          color: Theme.of(context).textTheme.bodyMedium!.color
                      )),
                ...
                Row(children: [
                  Expanded(
                    child: CheckboxListTile(
                      tileColor: hasBabySeat ? Theme.of(context).primaryColor.withValues(alpha: 0.05) : null,
                      contentPadding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
                      title: Text('baby_seat'.tr,style: textBold.copyWith(
                          fontSize: 12,
                          color: Theme.of(context).textTheme.bodyMedium!.color
                      )),
                      value: hasBabySeat,
                        ...
                        if (value!) {
                          showDialog(
                            ...
                            builder: (context) => AlertDialog(
                              title: Text('confirm_baby_seat'.tr),
                              content: Text('confirm_baby_seat_message'.tr),
                              actions: [
                                TextButton(
                  ...
                  Expanded(
                    child: CheckboxListTile(
                      tileColor: acceptsMaleCompanion ? Theme.of(context).primaryColor.withValues(alpha: 0.05) : null,
                      contentPadding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
                      title: Text('accepts_male_companion'.tr,style: textBold.copyWith(
                          fontSize: 12,
                          color: Theme.of(context).textTheme.bodyMedium!.color
                      )),
                      value: acceptsMaleCompanion,
                      onChanged: (value){
                        acceptsMaleCompanion = value!;
                        setState(() {});
                      },
                      activeColor: Theme.of(context).primaryColor,
                      checkColor: Colors.white,
                ...
                onPressed: (){
                  ...
                  if(fName.isEmpty){
                    ...
                    profileController.updateProfile(
                        ...
                        isKidsOnlyVerified,
                        isChildFriendly,
                        acceptsLowerTierRides,
                        hasBabySeat,
                        acceptsMaleCompanion,
                    );
                  }
                },
                radius: 5,
