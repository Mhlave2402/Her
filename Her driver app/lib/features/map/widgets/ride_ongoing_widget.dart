...
import 'package:her_driver_app/common_widgets/custom_date_picker.dart';
import 'package:her_driver_app/common_widgets/custom_time_picker.dart';
import 'package:her_driver_app/common_widgets/expandable_bottom_sheet.dart';
import 'package:her_driver_app/common_widgets/ride_completation_dialog_widget.dart';
...
import 'package:her_driver_app/features/map/widgets/parcel_cancelation_list.dart';
import 'package:her_driver_app/features/map/widgets/ride_cancelation_list.dart';
...
import 'package:her_driver_app/features/map/widgets/route_calculation_widget.dart';
import 'package:her_driver_app/features/map/widgets/route_widget.dart';
import 'package:her_driver_app/features/map/widgets/user_details_widget.dart';
      ...
      return GetBuilder<RiderMapController>(builder: (riderMapController) {
        return Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const SizedBox() :
            (!rideController.tripDetail!.isPaused! && rideController.tripDetail!.type != "parcel") ?
            Column(children: [
              SliderButton(
                action: () {
              ...
              SliderButton(
                ...
                label: Text( "cancel_ride".tr, style: textRegular.copyWith(color: Theme.of(context).colorScheme.error, fontSize: Dimensions.fontSizeLarge)),
                dismissThresholds: 0.5, dismissible: false, shimmer: false, width: 1170,
                height: 40, buttonSize: 40, radius: 20,
                icon: Center(child: Container(
                  width: 36, height: 36,
