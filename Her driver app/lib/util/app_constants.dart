...
class AppConstants {
  ...
  static const String zoneUri = '/api/driver/zone';
  static const String SOS_URI = '/api/driver/sos';
  static const String speedingEventUri = '/api/driver/behavior/speeding';
  static const String hardBrakingEventUri = '/api/driver/behavior/braking';
  static const String giftCardListUri = '/api/driver/giftcard/list';
  static const String tripPaymentUri = '/api/driver/giftcard/trip-payment';
  static const String recordShortfall = '/api/driver/ride/shortfall/record';
  static const String tierSettingsUri = '/api/v1/driver/tier-settings';
  static const String vehicleUri = '/api/v1/driver/vehicles';
