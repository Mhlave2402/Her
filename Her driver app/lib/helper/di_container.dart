...
import 'package:her_driver_app/features/auth/domain/repositories/auth_repository.dart';
import 'package:her_driver_app/features/auth/domain/repositories/auth_repository_interface.dart';
import 'package:her_driver_app/features/auth/domain/services/auth_service.dart';
import 'package:her_driver_app/features/auth/domain/services/auth_service_interface.dart';
import 'package:her_driver_app/features/chat/controllers/chat_controller.dart';
import 'package:her_driver_app/features/chat/domain/repositories/chat_repository.dart';
import 'package:her_driver_app/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:her_driver_app/features/chat/domain/services/chat_service.dart';
import 'package:her_driver_app/features/chat/domain/services/chat_service_interface.dart';
import 'package:her_driver_app/features/dashboard/controllers/bottom_menu_controller.dart';
import 'package:her_driver_app/features/help_and_support/controllers/help_and_support_controller.dart';
import 'package:her_driver_app/features/help_and_support/domain/repositories/help_and_support_repository.dart';
import 'package:her_driver_app/features/help_and_support/domain/repositories/help_and_support_repository_interface.dart';
import 'package:her_driver_app/features/help_and_support/domain/services/help_and_support_service.dart';
import 'package:her_driver_app/features/help_and_support/domain/services/help_and_support_service_interface.dart';
import 'package:her_driver_app/features/leaderboard/controllers/leader_board_controller.dart';
import 'package:her_driver_app/features/leaderboard/domain/repositories/leader_board_repository.dart';
import 'package:her_driver_app/features/leaderboard/domain/repositories/leader_board_repository_interface.dart';
import 'package:her_driver_app/features/leaderboard/domain/services/leader_board_service.dart';
import 'package:her_driver_app/features/leaderboard/domain/services/leader_board_service_interface.dart';
import 'package:her_driver_app/features/location/controllers/location_controller.dart';
import 'package:her_driver_app/features/location/domain/repositories/location_repository.dart';
import 'package:her_driver_app/features/location/domain/repositories/location_repository_interface.dart';
import 'package:her_driver_app/features/location/domain/services/location_service.dart';
...
import 'package:her_driver_app/features/notification/domain/repositories/notification_repository.dart';
import 'package:her_driver_app/features/notification/domain/repositories/notification_repository_interface.dart';
import 'package:her_driver_app/features/notification/domain/services/notification_service.dart';
...
import 'package:her_driver_app/features/out_of_zone/domain/repositories/out_of_zone_repository.dart';
import 'package:her_driver_app/features/out_of_zone/domain/repositories/out_of_zone_repository_interface.dart';
import 'package:her_driver_app/features/out_of_zone/domain/service/out_of_zone_service.dart';
import 'package:her_driver_app/features/out_of_zone/domain/service/out_of_zone_service_interface.dart';
import 'package:her_driver_app/features/profile/controllers/profile_controller.dart';
import 'package:her_driver_app/features/profile/domain/repositories/profile_repository.dart';
...
import 'package:her_driver_app/features/profile/controllers/driver_prefs_cubit.dart';
import 'package:her_driver_app/features/profile/domain/services/profile_service.dart';
import 'package:her_driver_app/features/profile/domain/services/profile_service_interface.dart';
import 'package:her_driver_app/features/refer_and_earn/controllers/refer_and_earn_controller.dart';
import 'package:her_driver_app/features/refer_and_earn/domain/repositories/refer_earn_repository.dart';
import 'package:her_driver_app/features/refer_and_earn/domain/repositories/refer_earn_repository_intertface.dart';
import 'package:her_driver_app/features/refer_and_earn/domain/services/refer_earn_service.dart';
import 'package:her_driver_app/features/refer_and_earn/domain/services/refer_earn_service_interface.dart';
import 'package:her_driver_app/features/review/controllers/review_controller.dart';
import 'package:her_driver_app/features/review/domain/repositories/review_repository.dart';
import 'package:her_driver_app/features/review/domain/repositories/review_repository_interface.dart';
import 'package:her_driver_app/features/review/domain/services/review_service.dart';
import 'package:her_driver_app/features/review/domain/services/review_service_interface.dart';
import 'package:her_driver_app/features/ride/controllers/ride_controller.dart';
import 'package:her_driver_app/features/ride/domain/repositories/ride_repository.dart';
import 'package:her_driver_app/features/ride/domain/repositories/ride_repository_interface.dart';
import 'package:her_driver_app/features/ride/domain/services/ride_service.dart';
...
import 'package:her_driver_app/features/safety_setup/domain/repositories/safety_alert_repository.dart';
import 'package:her_driver_app/features/safety_setup/domain/repositories/safety_alert_repository_interface.dart';
import 'package:her_driver_app/features/behavior_monitoring/controllers/behavior_controller.dart';
import 'package:her_driver_app/features/behavior_monitoring/data/repositories/behavior_repository.dart';
import 'package:her_driver_app/features/behavior_monitoring/domain/services/behavior_service.dart';
import 'package:her_driver_app/features/behavior_monitoring/domain/services/behavior_service_interface.dart';
import 'package:her_driver_app/features/safety_setup/domain/services/safety_alert_service.dart';
import 'package:her_driver_app/features/safety_setup/domain/services/safety_alert_service_interface.dart';
...
import 'package:her_driver_app/features/zone/controllers/zone_controller.dart';
...
import 'package:her_driver_app/features/splash/domain/repositories/splash_repository.dart';
import 'package:her_driver_app/data/api_client.dart';
import 'package:her_driver_app/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:her_driver_app/features/splash/domain/services/splash_service.dart';
import 'package:her_driver_app/features/splash/domain/services/splash_service_interface.dart';
import 'package:her_driver_app/features/trip/domain/repositories/trip_repository_interface.dart';
import 'package:her_driver_app/features/trip/domain/services/trip_service.dart';
import 'package:her_driver_app/features/trip/domain/services/trip_service_interface.dart';
import 'package:her_driver_app/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:her_driver_app/features/wallet/domain/services/wallet_service.dart';
import 'package:her_driver_app/features/wallet/domain/services/wallet_service_interface.dart';
import 'package:her_driver_app/localization/language_model.dart';
...
import 'package:her_driver_app/features/trip/domain/repositories/trip_repository.dart';
import 'package:her_driver_app/features/wallet/controllers/wallet_controller.dart';
import 'package:her_driver_app/features/wallet/domain/repositories/wallet_repository.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  Get.lazyPut<BehaviorServiceInterface>(() => BehaviorService(behaviorRepository: Get.find()));
  Get.lazyPut<BehaviorRepository>(() => BehaviorRepository(apiClient: Get.find()));
  ...
  Get.lazyPut(() => BehaviorService(behaviorRepository: Get.find()));
  ...
  Get.lazyPut(() => DriverPrefsRepository(apiClient: Get.find()));
  ...
  Get.lazyPut(() => DriverPrefsCubit(driverPrefsRepository: Get.find()));
