...
class _RouteWidget extends StatelessWidget {
  ...
  const _RouteWidget({required this.fromAddress, required this.toAddress});
    ...
    return Column(children: [
      Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Padding(
          ...
          child: Column(children:  [
            Container(
              ...
              child: Image.asset(Images.currentLocation, color: Theme.of(context).textTheme.bodyMedium?.color?.withValues(alpha: 0.7), height: 16, width: 16),
            ),

            SizedBox(height: 20 , width: 10, child: CustomDivider(
            ...
            Container(
              ...
              padding: EdgeInsets.all(Dimensions.paddingSizeSmall),
              child: Image.asset(Images.activityDirection, color: Theme.of(context).textTheme.bodyMedium?.color?.withValues(alpha: 0.7), height: 16, width: 16),
            ),
          ]),
        ),
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Text(
           toAddress,overflow: TextOverflow.ellipsis,maxLines: 2,
            style: textRegular.copyWith(color: Theme.of(context).textTheme.bodyMedium?.color?.withValues(alpha:0.7)),
          ),
