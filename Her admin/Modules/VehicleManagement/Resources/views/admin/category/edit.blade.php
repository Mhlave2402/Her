                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-4">
                                            <label for="child_friendly_fee"
                                                   class="mb-2">{{ translate('child_friendly_fee') }}</label>
                                            <input type="number" id="child_friendly_fee" name="child_friendly_fee"
                                                   class="form-control"
                                                   placeholder="Ex: 5" value="{{ $category->child_friendly_fee }}"
                                                   step=".01" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
