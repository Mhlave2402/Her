...
@section('content')
    ...
    <div class="main-content">
        <div class="container-fluid">
                        ...
                        <div class="col-lg-6">
                            <div class="">
                                ...
                                <div class="media gap-3 gap-lg-4">
                                    ...
                                    <div class="media-body">
                                        <div class="d-flex flex-column align-items-start gap-1">
                                            <h6 class="mb-2"><a href="{{route('admin.driver.show', ['id' => $vehicle?->driver?->id])}}">{{ $vehicle?->driver?->first_name }}
                                                    {{ $vehicle?->driver?->last_name }}</a></h6>
            ...
            @if(count($vehicle?->vehicle_photos) > 0)
                <div class="card border analytical_data mt-3">
                    <div class="card-body">
                        <h5 class="text-primary align-items-center mb-3 text-uppercase">{{ translate('vehicle_photos') }}</h5>
                        <div class="d-flex gap-3 flex-wrap">
                            @foreach($vehicle?->vehicle_photos as $photo)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/app/public/vehicle/') }}/{{ $photo }}"
                                         class="rounded" style="width: 150px; height: 150px; object-fit: cover;" alt="">
                                </div>
                            @endforeach
                        </div>
                    </div>
