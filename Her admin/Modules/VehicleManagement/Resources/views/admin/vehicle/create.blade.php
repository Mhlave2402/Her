            ...
            <form id="vehicle_form" action="{{ route('admin.vehicle.store') }}" enctype="multipart/form-data"
                ...
                <div class="row mb-3">
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="mb-4">
                                            ...
                                            <input type="checkbox" id="baby_seat" name="baby_seat_available" value="1">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="mb-4">
                                            <label class="form-check-label" for="child_friendly">{{ translate('child_friendly') }}</label>
                                            <input type="checkbox" id="child_friendly" name="is_child_friendly" value="1">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="mb-4">
                                            <label class="form-check-label" for="helmet_required">{{ translate('helmet_required') }}</label>
                                            <input type="checkbox" id="helmet_required" name="helmet_required" value="1">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="mb-4">
                                            <label for="load_capacity" class="mb-2">{{ translate('load_capacity') }} (kg)</label>
                                            <input type="number" id="load_capacity" class="form-control" name="load_capacity" placeholder="Ex: 1000">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="mb-4">
                                            <label for="color" class="mb-2">{{ translate('color') }} <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" value="{{ old('color') }}" id="color"
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap gap-3">
                                    ...
                                    <div class="upload-file file__input" id="file__input">
                                        <input type="file" name="documents[]" class="upload-file__input2" multiple="multiple">
                    ...
                    <div class="col-12">
                        <div class="card mt-3">
                            <div class="card-body">
                                <h5 class="mb-4 text-capitalize">{{ translate('upload_vehicle_photos') }}</h5>
                                <div class="d-flex flex-wrap gap-3">
                                    <div class="upload-file">
                                        <input type="file" name="vehicle_photos[]" class="upload-file__input" multiple="multiple" accept="image/*">
