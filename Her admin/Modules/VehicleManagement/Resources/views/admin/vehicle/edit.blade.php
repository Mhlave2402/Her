            ...
            <form action="{{ route('admin.vehicle.update', ['id' => $vehicle->id]) }}" enctype="multipart/form-data"
                ...
                <div class="row mb-3">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="mb-4">
                                            <label class="form-check-label" for="baby_seat">{{ translate('baby_seat') }}</label>
                                            <input type="checkbox" id="baby_seat" name="baby_seat_available" value="1" {{ $vehicle->baby_seat_available ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="mb-4">
                                            <label class="form-check-label" for="child_friendly">{{ translate('child_friendly') }}</label>
                                            <input type="checkbox" id="child_friendly" name="is_child_friendly" value="1" {{ $vehicle->is_child_friendly ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="mb-4">
                                            <label class="form-check-label" for="helmet_required">{{ translate('helmet_required') }}</label>
                                            <input type="checkbox" id="helmet_required" name="helmet_required" value="1" {{ $vehicle->helmet_required ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="mb-4">
                                            <label for="load_capacity" class="mb-2">{{ translate('load_capacity') }} (kg)</label>
                                            <input type="number" id="load_capacity" class="form-control" name="load_capacity" value="{{ $vehicle->load_capacity }}" placeholder="Ex: 1000">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="mb-4">
                                            <label for="color" class="mb-2">{{ translate('color') }} <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" value="{{ $vehicle->color }}" id="color"
                                                   class="form-control" name="color"
                                                   placeholder="Ex: #000000" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="card mt-3">
                            <div class="card-body">
                                <h5 class="mb-4 text-primary text-uppercase">{{ translate('upload_documents') }}</h5>
                                <div class="d-flex flex-wrap gap-3">
                                    ...
                                    <div class="upload-file file__input" id="file__input">
                                        <input type="file" name="documents[]" class="upload-file__input2" multiple/>
                    ...
                    <div class="col-12">
                        <div class="card mt-3">
                            <div class="card-body">
                                <h5 class="mb-4 text-primary text-uppercase">{{ translate('upload_vehicle_photos') }}</h5>
                                <div class="d-flex flex-wrap gap-3">
                                    @if (!empty($vehicle->vehicle_photos))
                                        @foreach ($vehicle->vehicle_photos as $photo)
                                            <div class="show-image">
                                                <img src="{{ asset('storage/app/public/vehicle/' . $photo) }}" class="rounded" style="width: 150px; height: 150px; object-fit: cover;" alt="">
                                            </div>
                                        @endforeach
                                    @endif
                                </div>
                                <div class="upload-file mt-3">
                                    <input type="file" name="vehicle_photos[]" class="upload-file__input" multiple accept
                </div>
