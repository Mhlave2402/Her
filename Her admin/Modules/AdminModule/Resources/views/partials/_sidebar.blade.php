        ...
        <div class="aside-body" data-trigger="scrollbar">
            ...
            <ul class="main-nav nav">
                ...
                @if(\Illuminate\Support\Facades\Gate::any(['user_view', 'user_add', 'user_edit', 'user_delete', 'user_log', 'user_export']))
                    ...
                    <li class="{{Request::is('admin/driver/behavior*')? 'active open' : ''}}">
                        <a href="{{route('admin.driver.behavior.index')}}">
                            <i class="bi bi-cone-striped"></i>
                            <span class="link-title text-capitalize">{{translate('driver_behavior')}}</span>
                        </a>
                    </li>
                    <li class="{{Request::is('admin/driver/report*')? 'active open' : ''}}">
                        <a href="{{route('admin.driver.report.index')}}">
                            <i class="bi bi-shield-exclamation"></i>
                            <span class="link-title text-capitalize">{{translate('driver_reports')}}</span>
                        </a>
                    </li>
                    <!---------- End user Management --------------->
                @endif
                ...
                @if(\Illuminate\Support\Facades\Gate::any(['vehicle_view', 'vehicle_add', 'vehicle_edit', 'vehicle_delete', 'vehicle_log', 'vehicle_export']))
                    ...
                    <li class="{{Request::is('admin/vehicle/category*')?'active open':''}}">
                        <a href="{{ route('admin.vehicle.category.index') }}">
                            <i class="bi bi-card-list"></i>
                            <span class="link-title text-capitalize">{{ translate('vehicle_categories') }}</span>
                        </a>
                    </li>
                ...
                @if(\Illuminate\Support\Facades\Gate::any(['fare_view', 'fare_add']))
                    ...
                    <li class="{{Request::is('admin/fare/trip*')? 'active open' : ''}}">
                        <a href="{{route('admin.fare.trip.index')}}">
                            ...
                            <span class="text-truncate">{{translate('trips')}}</span>
                        </a>
                    </li>
                    <li class="{{Request::is('admin/fare/child-friendly*')? 'active open' : ''}}">
                        <a href="{{route('admin.fare.child-friendly')}}">
                            <span class="tio-circle nav-indicator-icon"></span>
                            <span class="text-truncate">{{translate('child_friendly_fare')}}</span>
                        </a>
                    </li>
