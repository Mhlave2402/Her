                    ...
                    <form action="{{route('admin.business.setup.trip-fare.store')."?type=".TRIP_FARE_SETTINGS}}" id="fare_and_penalty_form" method="POST">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-4">
                                        <label for="male_companion_fee" class="mb-2">{{ translate('male_companion_fee') }} (%)</label>
                                        <div class="input-group_tooltip">
                                            <input type="number" class="form-control" placeholder="Ex: 10" id="male_companion_fee" name="male_companion_fee" value="{{$settings->firstWhere('key_name', 'male_companion_fee')?->value}}">
                                            <i class="bi bi-info-circle-fill text-primary tooltip-icon" data-bs-toggle="tooltip"
                                                    data-bs-title="{{ translate('The percentage of the trip fare that will be added as a surcharge when a female driver is accompanied by a male passenger.') }}"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
