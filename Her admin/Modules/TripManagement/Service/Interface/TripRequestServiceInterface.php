...
//    public function handleDriverStatusUpdate($request, $trip);
    ...
    public function findNearestDrivers(string $latitude, string $longitude, string $zoneId, int|string $radius, string $vehicleCategoryId = null, string $requestType = null, string $rideRequestType = null, int|string $parcelWeight = null, bool $with_male_companion = false): mixed;
