                        ...
                        <div class="row gy-4">
                            <div class="col-lg-8">
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-4">
                                            <label for="gender" class="mb-2">{{ translate('gender') }}
                                                <span class="text-danger">*</span></label>
                                            <select name="gender" class="js-select text-capitalize"
                                                    id="gender" required>
                                                <option value="female" {{ $driver->gender == 'female' ? 'selected' : '' }}>{{ translate('female') }}</option>
                                                <option value="gay" {{ $driver->gender == 'gay' ? 'selected' : '' }}>{{ translate('gay') }}</option>
                                                <option value="any" {{ $driver->gender == 'any' ? 'selected' : '' }}>{{ translate('any') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
