...
use Modules\UserManagement\Http\Controllers\Web\Admin\DriverBehaviorController;
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => 'admin'], function () {
    ...
    Route::group(['prefix' => 'driver', 'as' => 'driver.'], function () {
        ...
        Route::group(['prefix' => 'behavior', 'as' => 'behavior.'], function () {
            Route::any('/', [DriverBehaviorController::class, 'index'])->name('index');
        });
