...
use Modules\UserManagement\Http\Controllers\Api\PayoutHistoryController;
use Modules\UserManagement\Http\Controllers\Api\PayoutSettingsController;
...
Route::group(['prefix' => 'driver'], function () {
    Route::group(['middleware' => ['auth:api', 'maintenance_mode']], function () {
        ...
        Route::post('payout-settings', [PayoutSettingsController::class, 'update']);
        Route::get('payout-history', [PayoutHistoryController::class, 'index']);
    });
