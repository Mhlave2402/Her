...
class DriverController extends Controller
{
    ...
    public function updateProfile(Request $request): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            ...
            'accepts_lower_tier_rides' => 'boolean'
        ]);
        ...
        $data = $request->except('identity_images', 'profile_image', 'existing_documents');
        if ($request->has('accepts_lower_tier_rides')) {
            $data['accepts_lower_tier_rides'] = $request->accepts_lower_tier_rides;
        }

        $this->driverService->update(id: $request->user()->id, data: $data);
