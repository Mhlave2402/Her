...
use App\Http\Controllers\Admin\BabySeatFeeController;
...
Route::resource('admin/baby-seat-fee', BabySeatFeeController::class)->middleware('auth');
Route::resource('admin/child-friendly-fee', ChildFriendlyFeeController::class)->middleware('auth');

Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['auth', 'admin']], function () {
    Route::get('nanny-management', function () {
        return view('admin.nanny');
    })->name('nanny.management');

    Route::resource('feature-fees', \App\Http\Controllers\Admin\FeatureFeeConfigController::class);
});
