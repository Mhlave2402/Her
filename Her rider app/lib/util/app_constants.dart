...
import 'package:her_user_app/features/onboard/domain/models/on_boarding_model.dart';
...
class AppConstants {
  ...
  static const double appVersion = 2.5; /// Flutter SDK 3.32.6
  ...
  static const String identityVerificationUpload = '/api/identity-verification/upload';
  static const String identityVerificationStatus = '/api/identity-verification/status';
  static const String getRunningRideList = '/api/customer/ride/pending-ride-list';
  static const String zoneUri = '/api/customer/zone';
  static const String sosUri = '/api/customer/sos';
  static const String giftCardRedeemUri = '/api/customer/giftcard/redeem';
  static const String giftCardBalanceUri = '/api/customer/giftcard/balance';
  static const String giftCardListUri = '/api/customer/giftcard/list';
  static const String redeemGiftCardUri = '/api/wallet/redeem-gift-card';
  static const String topUpWithCardUri = '/api/wallet/top-up-with-card';
  static const String splitPaymentRequestUri = '/api/customer/split-payment/request';
  static const String splitPaymentAcceptUri = '/api/customer/split-payment/accept';
  static const String driverBehaviorUri = '/api/customer/driver-behavior';
  static const String driverReportUri = '/api/customer/driver-report';
  static const String biometricLogin = '/api/customer/auth/biometric-login';
  static const String payShortfallUri = '/api/customer/ride/shortfall/pay';
  ...
  static const String faceIdKey = 'face_id_key';
