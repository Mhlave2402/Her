...
import 'package:her_user_app/features/address/screens/search_and_pick_location_screen.dart';
              ...
              child: Padding(
                ...
                ButtonWidget(
                  ...
                  onPressed: () {
                    ...
                    if(location.isEmpty) {
                      customSnackBar('address_is_required'.tr);
                    }else if(name.isEmpty) {
                      customSnackBar('name_is_required'.tr);
                    }else if(phone.isEmpty) {
                      customSnackBar('phone_is_required'.tr);
                    }else if(addressController.selectAddressIndex == 2 && levelName.isEmpty){
                      customSnackBar('address_level_name_required'.tr);
                    }else{
