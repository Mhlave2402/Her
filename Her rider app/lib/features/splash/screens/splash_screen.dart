...
import 'package:her_user_app/features/maintainance_mode/maintainance_screen.dart';
import 'package:her_user_app/features/onboard/screens/onboarding_screen.dart';
...
import 'package:her_user_app/features/splash/screens/app_version_warning_screen.dart';
import 'package:her_user_app/features/trip/controllers/trip_controller.dart';
import 'package:her_user_app/helper/firebase_helper.dart';
import 'package:her_user_app/helper/notification_helper.dart';
...
class _SplashScreenState extends State<SplashScreen> with SingleTickerProviderStateMixin {
  ...
  void forLoginUserRoute() async {
    await Get.find<ZoneController>().getZone('user');
    if(widget.notificationData != null) {
      NotificationHelper.notificationRouteCheck(widget.notificationData!, formSplash: true, userName: widget.userName);
