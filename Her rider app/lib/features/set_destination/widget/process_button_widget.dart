            ...
            ButtonWidget(
              onPressed: () {
                if(Get.find<ConfigController>().config!.maintenanceMode != null &&
                  ...
                  customSnackBar('maintenance_mode_on_for_ride'.tr,isError: true);
                }else{
                  if(locationController.fromAddress == null ||
                    ...
                    customSnackBar('pickup_location_is_required'.tr);
                    ...
                    customSnackBar('destination_location_is_required'.tr);
