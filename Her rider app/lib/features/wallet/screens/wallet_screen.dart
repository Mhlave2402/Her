...
import 'package:her_user_app/common_widgets/profile_type_button_widget.dart';
...
import 'package:her_user_app/features/wallet/screens/loyality_point_screen.dart';
import 'package:her_user_app/features/wallet/widget/animated_expanded_fab_button.dart';
import 'package:her_user_app/features/wallet/widget/animated_fab_button.dart';
import 'package:her_user_app/features/wallet/widget/wallet_money_screen.dart';
          ...
          child: Scaffold(
            ...
            body: GetBuilder<WalletController>(builder: (walletController) {
              return Stack(children: [
                BodyWidget(
                    appBar: AppBarWidget(
                        title: 'wallet'.tr, centerTitle: true,
                      onBackPressed: (){
                        if(Get.find<WalletController>().currentTabIndex == 1){
                          Get.find<WalletController>().updateCurrentTabIndex(0,isUpdate: true);
                        }else {
