...
class WalletRepository implements WalletRepositoryInterface{
  ...
  Future<Response> redeemGiftCard(String code) async {
    return await apiClient.postData(AppConstants.redeemGiftCardUri, {'code': code});
  }

  @override
  Future<Response> topUpWithCard(String amount, String token) async {
    return await apiClient.postData(AppConstants.topUpWithCardUri, {'amount': amount, 'token': token});
  }
}
