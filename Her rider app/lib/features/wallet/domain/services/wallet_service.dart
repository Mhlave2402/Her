...
@override
  ...
  @override
  Future redeemGiftCard(String code) async{
    return await walletRepositoryInterface.redeemGiftCard(code);
  }

  @override
  Future topUpWithCard(String amount, String token) async{
    return await walletRepositoryInterface.topUpWithCard(amount, token);
  }
}
