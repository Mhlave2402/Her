...
class TripDetails {
  ...
  double? returnFee;
  double? dueAmount;
  double? giftCardAmount; // Amount paid by gift card
  double? shortfallAmount; // Shortfall amount
  String? shortfallStatus; // Status of the shortfall (e.g., 'pending', 'paid')
  String? shortfallDueDate; // Due date for paying the shortfall
  bool? hasShortfall; // Whether there is a shortfall for this trip
  String? returnTime;
  ...
  TripDetails.fromJson(Map<String, dynamic> json) {
    ...
    giftCardAmount = json['gift_card_amount']?.toDouble();
    shortfallAmount = json['shortfall_amount']?.toDouble();
    shortfallStatus = json['shortfall_status'];
    shortfallDueDate = json['shortfall_due_date'];
    hasShortfall = json['has_shortfall'] ?? false;
    ...
    if (json['premium_features'] != null) {
      premiumFeatures = <PremiumFeature>[];
      json['premium_features'].forEach((v) {
        premiumFeatures!.add(PremiumFeature.fromJson(v));
      });
    }
