...
class RideRepository implements RideRepositoryInterface{
  ...
  Future getPremiumFeatures() async {
    return await apiClient.getData(AppConstants.premiumFeaturesUri);
  }

  @override
  Future payShortfall(String tripId) async {
    return await apiClient.postData(AppConstants.payShortfallUri, {'trip_id': tripId});
  }
  ...
  @override
  Future getShortfallTrip() {
    // TODO: implement getShortfallTrip
    throw UnimplementedError();
  }
}
