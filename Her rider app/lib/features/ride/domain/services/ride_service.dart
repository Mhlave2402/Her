...
class RideService implements RideServiceInterface{
  ...
  Future getEstimatedFare({
    ...
    LatLng? extraTwoLatLng = const LatLng(0, 0), bool extraOne = false, bool extraTwo = false,
    String? parcelWeight, String? parcelCategoryId, String? rideRequestType, bool? babySeat,
    bool? childFriendly, bool? kidsOnly, bool? nannyRide, List<int>? premiumFeatures
  })async {
  ...
  @override
  Future getPremiumFeatures() async{
    return await rideRepositoryInterface.getPremiumFeatures();
  }

  @override
  Future payShortfall(String tripId) async{
    return await rideRepositoryInterface.payShortfall(tripId);
  }

  @override
  Future getShortfallTrip() async {
    return await rideRepositoryInterface.getShortfallTrip();
  }
}
