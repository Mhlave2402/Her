...
class AuthService implements AuthServiceInterface{
  ...
  @override
  Future biometricLogin({required String faceIdKey}) async{
    return await authRepositoryInterface.biometricLogin(faceIdKey: faceIdKey);
  }

  @override
  void saveFaceIdKey(String key) {
    authRepositoryInterface.saveFaceIdKey(key);
  }

  @override
  String? getFaceIdKey() {
    return authRepositoryInterface.getFaceIdKey();
  }

  @override
  Future<void> saveBiometricAuth(bool status) {
    return authRepositoryInterface.saveBiometricAuth(status);
  }

  @override
  bool isBiometricAuthEnabled() {
    return authRepositoryInterface.isBiometricAuthEnabled();
  }
}
