...
class AuthRepository implements AuthRepositoryInterface{
  ...
  @override
  Future<void> saveBiometricAuth(bool status) async {
    await sharedPreferences.setBool(AppConstants.biometricAuth, status);
  }
  ...
  @override
  Future<Response?> biometricLogin({required String faceIdKey}) async {
    return await apiClient.postData(AppConstants.biometricLogin, {"token": faceIdKey});
  }

  @override
  void saveFaceIdKey(String key) {
    sharedPreferences.setString(AppConstants.faceIdKey, key);
  }

  @override
  String? getFaceIdKey() {
    return sharedPreferences.getString(AppConstants.faceIdKey);
  }
}
