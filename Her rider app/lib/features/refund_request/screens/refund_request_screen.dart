...
import 'package:her_user_app/features/refund_request/screens/image_Video_viewer.dart';
import 'package:her_user_app/features/refund_request/widgets/pick_button_widget.dart';
...
customSnackBar('product_approximate_price_required'.tr);

    }else if(refundRequestController.proofImages.isEmpty){
      customSnackBar('proof_required'.tr);
