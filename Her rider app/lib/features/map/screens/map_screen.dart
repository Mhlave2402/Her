...
import 'package:her_user_app/features/map/widget/custom_icon_card.dart';
import 'package:her_user_app/features/map/widget/discount_coupon_bottomsheet.dart';
...
import 'package:her_user_app/features/parcel/widgets/parcel_expendable_bottom_sheet.dart';
import 'package:her_user_app/features/payment/screens/payment_screen.dart';
import 'package:her_user_app/features/ride/widgets/ride_expendable_bottom_sheet.dart';
          ...
          body: GetBuilder<RideController>(builder: (rideController){
            return Stack(children: [
              BodyWidget(topMargin: 0,
                appBar: AppBarWidget(
                  title: widget.fromScreen == MapScreenType.parcel ? 'your_trip'.tr : _getAppbarTitle(rideController),
                      ...
                      return Stack(children: [
                        Padding(
                          ...
                          child: GoogleMap(
                              ...
                              onCameraMove: (position) {
                                if(widget.fromScreen == MapScreenType.location) {
                                  Get.find<LocationController>().onCameraMove(position.target);
                                }
                              },
                        ...
                        if(widget.fromScreen == MapScreenType.location)
                          Center(child: Padding(
                            padding: EdgeInsets.only(bottom: mapController.sheetHeight),
                            child: Image.asset(Images.mapLocationIcon, height: 35, width: 35),
                          )),
