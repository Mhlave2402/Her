...
import 'package:her_user_app/common_widgets/expandable_bottom_sheet.dart';
...
import 'package:her_user_app/features/parcel/widgets/fare_input_widget.dart';
import 'package:her_user_app/features/parcel/widgets/route_widget.dart';
...
import 'package:her_user_app/features/ride/widgets/ride_category.dart';
import 'package:her_user_app/features/ride/widgets/trip_fare_summery.dart';
...
import 'package:her_user_app/features/trip/screens/trip_details_screen.dart';
      ...
      return GetBuilder<LocationController>(builder: (locationController){
        return Column(mainAxisSize: MainAxisSize.min, children:  [
          ...
          Row(
            ...
            children: [
              Text('preferred_gender'.tr, style: textRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
              Row(
                children: [
                  GestureDetector(
                    onTap: () => rideController.setGender('female'),
                    child: Container(
                      padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall, vertical: Dimensions.paddingSizeExtraSmall),
                      decoration: BoxDecoration(
                        color: rideController.gender == 'female' ? Theme.of(context).primaryColor : Theme.of(context).primaryColor.withOpacity(0.1),
                        borderRadius: BorderRadius.circular(Dimensions.paddingSizeExtraSmall),
                      ),
                      child: Text('female'.tr, style: textRegular.copyWith(color: rideController.gender == 'female' ? Colors.white : Theme.of(context).primaryColor)),
                    ),
                  ),
                  const SizedBox(width: Dimensions.paddingSizeSmall),
                  GestureDetector(
                    onTap: () => rideController.setGender('gay'),
                    child: Container(
                      padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall, vertical: Dimensions.paddingSizeExtraSmall),
                      decoration: BoxDecoration(
                        color: rideController.gender == 'gay' ? Theme.of(context).primaryColor : Theme.of(context).primaryColor.withOpacity(0.1),
                        borderRadius: BorderRadius.circular(Dimensions.paddingSizeExtraSmall),
                      ),
                      child: Text('gay'.tr, style: textRegular.copyWith(color: rideController.gender == 'gay' ? Colors.white : Theme.of(context).primaryColor)),
                    ),
                  ),
                  const SizedBox(width: Dimensions.paddingSizeSmall),
                  GestureDetector(
                    onTap: () => rideController.setGender('any'),
                    child: Container(
                      padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall, vertical: Dimensions.paddingSizeExtraSmall),
                      decoration: BoxDecoration(
                        color: rideController.gender == 'any' ? Theme.of(context).primaryColor : Theme.of(context).primaryColor.withOpacity(0.1),
                        borderRadius: BorderRadius.circular(Dimensions.paddingSizeExtraSmall),
                      ),
                      child: Text('any'.tr, style: textRegular.copyWith(color: rideController.gender == 'any' ? Colors.white : Theme.of(context).primaryColor)),
                    ),
                  ),
                ],
              ),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text('baby_seat'.tr, style: textRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
              Switch(
                value: rideController.needBabySeat,
                onChanged: (value) {
                  rideController.setBabySeat(value);
                },
              ),
            ],
          ),
