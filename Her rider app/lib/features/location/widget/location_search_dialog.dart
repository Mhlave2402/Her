          ...
          child: SizedBox(
            width: Get.width, child: TypeAheadField<Suggestions>(
             ...
             itemBuilder: (context, Suggestions suggestion ) {
              ...
              Get.find<LocationController>().setLocation(suggestion.placePrediction?.placeId ?? '', suggestion.placePrediction?.text?.text ?? '', mapController, type: type, fromSearch: true);
              Get.back();
            },
              emptyBuilder: (value) {
