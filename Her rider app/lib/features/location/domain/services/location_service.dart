...
class LocationService implements LocationServiceInterface{
  ...
  @override
  Future searchLocation(String text, String latitude, String longitude) async{
    return await locationRepositoryInterface.searchLocation(text, latitude, longitude);
  }
