...
import 'package:her_user_app/features/location/domain/models/place_details_model.dart';
import 'package:her_user_app/features/location/domain/models/prediction_model.dart';
import 'package:her_user_app/features/location/domain/models/zone_response.dart';
...
class LocationController extends GetxController implements GetxService {
  ...
  Future<List<Suggestions>?> searchLocation(BuildContext context, String text, {LocationType type = LocationType.from, bool fromMap = false}) async {
    ...
    if(text.isNotEmpty) {
      ...
      Response response = await locationServiceInterface.searchLocation(text, _position.latitude.toString(), _position.longitude.toString());
      if (response.statusCode == 200) {
