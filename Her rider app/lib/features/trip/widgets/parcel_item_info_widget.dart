...
class ParcelItemInfoWidget extends StatefulWidget {
  final String? icon;
  final String title;
  final double amount;
  ...
  const ParcelItemInfoWidget({super.key, required this.title,  this.icon, required this.amount,  this.isSubTotal = false,
    this.isFromTripDetails = false, this.paymentType, this.discount = false,this.subTitle,this.toolTipText});

  @override
  State<ParcelItemInfoWidget> createState() => _ParcelItemInfoWidgetState();
}

class _ParcelItemInfoWidgetState extends State<ParcelItemInfoWidget> {
