...
import 'package:her_user_app/features/auth/widgets/test_field_title.dart';
          ...
          onPressed: () {
            ...
            if(parcelController.tabController.index == 0) {
              if(parcelController.senderContactController.text.isEmpty){
                customSnackBar('enter_sender_contact_number'.tr);
                ...
                customSnackBar('enter_valid_contact_number'.tr);
                FocusScope.of(context).requestFocus(parcelController.senderContactNode);

              }else if(parcelController.senderNameController.text.isEmpty){
                customSnackBar('enter_sender_name'.tr);
                ...
                customSnackBar('enter_sender_address'.tr);
              ...
              if(parcelController.receiverContactController.text.isEmpty){
                customSnackBar('enter_receiver_contact_number'.tr);
                ...
                customSnackBar('enter_receiver_name'.tr);
                ...
                customSnackBar('enter_receiver_address'.tr);
                RouteHelper.goPageAndHideTextField(context, PickMapScreen(
