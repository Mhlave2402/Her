...
import 'package:her_user_app/features/address/domain/repositories/address_repository_interface.dart';
import 'package:her_user_app/features/address/domain/services/address_service.dart';
import 'package:her_user_app/features/address/domain/services/address_service_interface.dart';
import 'package:her_user_app/features/auth/domain/repositories/auth_repository_interface.dart';
import 'package:her_user_app/features/auth/domain/services/auth_service.dart';
import 'package:her_user_app/features/auth/domain/services/auth_service_interface.dart';
import 'package:her_user_app/features/coupon/domain/repositories/coupon_repository_interface.dart';
import 'package:her_user_app/features/coupon/domain/services/coupon_service.dart';
...
import 'package:her_user_app/features/location/domain/repositories/location_repository.dart';
import 'package:her_user_app/features/location/domain/repositories/location_repository_interface.dart';
import 'package:her_user_app/features/location/domain/services/location_service.dart';
import 'package:her_user_app/features/location/domain/services/location_service_interface.dart';
import 'package:her_user_app/features/message/domain/repositories/message_repository.dart';
import 'package:her_user_app/features/message/domain/repositories/message_repository_interface.dart';
import 'package:her_user_app/features/message/domain/services/message_service.dart';
import 'package:her_user_app/features/message/domain/services/message_service_interface.dart';
import 'package:her_user_app/features/my_level/controller/level_controller.dart';
import 'package:her_user_app/features/my_level/domain/repositories/level_repository.dart';
import 'package:her_user_app/features/my_level/domain/repositories/level_repository_interface.dart';
import 'package:her_user_app/features/my_level/domain/services/level_service.dart';
import 'package:her_user_app/features/my_level/domain/services/level_service_interface.dart';
import 'package:her_user_app/features/my_offer/controller/offer_controller.dart';
import 'package:her_user_app/features/my_offer/domain/repositories/offer_repository.dart';
import 'package:her_user_app/features/my_offer/domain/repositories/offer_repository_interface.dart';
import 'package:her_user_app/features/my_offer/domain/services/offer_service.dart';
import 'package:her_user_app/features/my_offer/domain/services/offer_service_interface.dart';
import 'package:her_user_app/features/notification/controllers/notification_controller.dart';
import 'package:her_user_app/features/notification/domain/repositories/notification_repository.dart';
import 'package:her_user_app/features/notification/domain/repositories/notification_repository_interface.dart';
import 'package:her_user_app/features/notification/domain/services/notification_service.dart';
import 'package:her_user_app/features/notification/domain/services/notification_service_interface.dart';
import 'package:her_user_app/features/onboard/controllers/on_board_page_controller.dart';
import 'package:her_user_app/features/parcel/domain/repositories/parcel_repository.dart';
import 'package:her_user_app/features/parcel/domain/repositories/parcel_repository_interface.dart';
import 'package:her_user_app/features/parcel/domain/services/parcel_service.dart';
...
import 'package:her_user_app/features/payment/domain/repositories/payment_repository.dart';
import 'package:her_user_app/features/payment/domain/repositories/payment_repository_interface.dart';
import 'package:her_user_app/features/payment/domain/services/payment_service.dart';
import 'package:her_user_app/features/payment/domain/services/payment_service_interface.dart';
import 'package:her_user_app/features/profile/domain/repositories/profile_repository.dart';
import 'package:her_user_app/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:her_user_app/features/profile/domain/services/profile_service.dart';
import 'package:her_user_app/features/profile/domain/services/profile_service_interface.dart';
import 'package:her_user_app/features/refer_and_earn/controllers/refer_and_earn_controller.dart';
import 'package:her_user_app/features/refer_and_earn/domain/repositories/refer_earn_repository.dart';
import 'package:her_user_app/features/refer_and_earn/domain/repositories/refer_earn_repository_interface.dart';
import 'package:her_user_app/features/refer_and_earn/domain/services/refer_earn_service.dart';
import 'package:her_user_app/features/refer_and_earn/domain/services/refer_earn_service_interface.dart';
import 'package:her_user_app/features/refund_request/controllers/refund_request_controller.dart';
import 'package:her_user_app/features/refund_request/domain/repositories/refund_request_repository.dart';
import 'package:her_user_app/features/refund_request/domain/repositories/refund_request_repository_interface.dart';
import 'package:her_user_app/features/refund_request/domain/services/refund_request_service.dart';
import 'package:her_user_app/features/refund_request/domain/services/refund_request_service_interface.dart';
import 'package:her_user_app/features/ride/domain/repositories/ride_repository.dart';
import 'package:her_user_app/features/ride/domain/repositories/ride_repository_interface.dart';
import 'package:her_user_app/features/ride/domain/services/ride_service.dart';
import 'package:her_user_app/features/ride/domain/services/ride_service_interface.dart';
import 'package:her_user_app/features/safety_setup/controllers/safety_alert_controller.dart';
import 'package:her_user_app/features/safety_setup/domain/repositories/safety_alert_repository.dart';
import 'package:her_user_app/features/safety_setup/domain/repositories/safety_alert_repository_interface.dart';
import 'package:her_user_app/features/safety_setup/domain/services/safety_alert_service.dart';
import 'package:her_user_app/features/safety_setup/domain/services/safety_alert_service_interface.dart';
import 'package:her_user_app/features/behavior_monitoring/controllers/behavior_controller.dart';
import 'package:her_user_app/features/behavior_monitoring/data/repositories/behavior_repository.dart';
import 'package:her_user_app/features/behavior_monitoring/domain/repositories/behavior_repository_interface.dart';
import 'package:her_user_app/features/behavior_monitoring/domain/services/behavior_service.dart';
...
import 'package:her_user_app/features/sos/controllers/sos_controller.dart';
import 'package:her_user_app/features/sos/data/sos_repository.dart';
import 'package:her_user_app/features/zone/controllers/zone_controller.dart';
import 'package:her_user_app/features/zone/data/zone_repository.dart';
import 'package:her_user_app/features/splash/domain/repositories/config_repository.dart';
import 'package:her_user_app/features/splash/domain/repositories/config_repository_interface.dart';
import 'package:her_user_app/features/splash/domain/services/config_service.dart';
import 'package:her_user_app/features/splash/domain/services/config_service_interface.dart';
import 'package:her_user_app/features/support/controllers/help_support_controller.dart';
import 'package:her_user_app/features/trip/controllers/trip_controller.dart';
import 'package:her_user_app/features/trip/data/split_payment_repository.dart';
...
import 'package:her_user_app/features/coupon/domain/repositories/coupon_repository.dart';
...
import 'package:her_user_app/features/address/domain/repositories/address_repository.dart';
import 'package:her_user_app/features/home/domain/repositories/banner_repo.dart';
...
import 'package:her_user_app/features/auth/domain/repositories/auth_repository.dart';
import 'package:her_user_app/features/message/controllers/message_controller.dart';
...
import 'package:her_user_app/features/trip/domain/repositories/trip_repository.dart';
import 'package:her_user_app/features/trip/domain/repositories/trip_repository_interface.dart';
import 'package:her_user_app/features/trip/domain/services/service.dart';
import 'package:her_user_app/features/trip/domain/services/service_interface.dart';
import 'package:her_user_app/features/wallet/controllers/wallet_controller.dart';
import 'package:her_user_app/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:her_user_app/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:her_user_app/features/wallet/domain/services/wallet_service.dart';
import 'package:her_user_app/features/wallet/domain/services/wallet_service_interface.dart';
import 'package:her_user_app/localization/language_model.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  Get.lazyPut(() => BehaviorService(behaviorRepositoryInterface: Get.find()));
  Get.lazyPut(() => ZoneConditionService());
  ...
  Get.lazyPut(() => BehaviorRepository(apiClient: Get.find()));
  Get.lazyPut(() => ZoneRepository(apiClient: Get.find()));
  Get.lazyPut(() => SosRepository(apiClient: Get.find()));
  Get.lazyPut(() => SplitPaymentRepository(apiClient: Get.find()));
  ...
  Get.lazyPut(() => TripController(tripServiceInterface: Get.find(), splitPaymentRepository: Get.find()));
  ...
  Get.lazyPut(() => BehaviorController(behaviorServiceInterface: Get.find()));
  Get.lazyPut(() => UserBehaviorController());
  Get.lazyPut(() => ZoneConditionController(zoneConditionService: Get.find()));
  Get.lazyPut(() => ZoneController(zoneRepository: Get.find(), sharedPreferences: Get.find()));
  Get.lazyPut(() => SosController(sosRepository: Get.find()));
  ...
  BehaviorRepositoryInterface behaviorRepositoryInterface = BehaviorRepository(apiClient: Get.find());
  Get.lazyPut(() => behaviorRepositoryInterface);
  BehaviorServiceInterface behaviorServiceInterface = BehaviorService(behaviorRepositoryInterface: Get.find());
  Get.lazyPut(() => behaviorServiceInterface);
