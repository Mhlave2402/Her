...
class PriceConverter {
  ...
  static String convertPrice(double price, {double? discount, String? discountType,bool? loyaltyPoint}) {
    bool inRight = Get.find<ZoneController>().currencyPosition == 'right';
    String decimal = Get.find<ZoneController>().currencyDecimalPoint ?? '1';
    String symbol = loyaltyPoint == null ? Get.find<ZoneController>().currencySymbol ?? '\$' : '';
    String finalResult;
